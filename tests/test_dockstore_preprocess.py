...
def parse_inputs(args):
    ...
    parser.add_argument("-p", "--pull-all", required = False, action="store_true", type=bool, help = "whether to pull all variables; don't specify --pull-json at the same time")
    parser.add_argument("-s", "--dockstore", required = False, action="store_true", type=bool, help = "whether to activate functions for dockstore")
    parser.add_argument("-w", "--import-metas", required = False, action="store_true", type=bool, help = "whether to pull parameter_metas from imported subworkflows")
